                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu multi-column columns-3">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 menu-img-pad">
                                      <a href="#">
                                        <img src="images/menu1.jpg" alt="/" class="img-rsponsive men-img-wid" />
                                      </a>
                                    </div>
                                    <div class="col-sm-4 menu-img-pad">
                                      <a href="#">
                                        <img src="images/menu2.jpg" alt="/" class="img-rsponsive men-img-wid" />
                                      </a>
                                    </div>
                                </div>
                            </ul>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu multi-column columns-2">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                      <a href="#">
                                        <img src="images/menu3.jpg" alt="/" class="img-rsponsive men-img-wid" />
                                      </a>
                                    </div>
                                </div>
                            </ul>
